...
public class Admin extends Composite {
	...
	private void loadComplaints() {
		TypedQuery<UserComplaint> query = em.createNamedQuery("allComplaints",
				UserComplaint.class);
	 ...
	 * clients to indicate that somebody just created or updated a
	 * UserComplaint.
	 * 
	 * @param created
	 *            The UserComplaint object that was just created or updated on
	 *            the server.
	 */
	 ...
	 * sync request to update this client's "world view". This is essentially
	 * just an optimization as the next sync request's response would also
	 * contain this {@link UserComplaint} object.
	 * 
	 * @param userComplaint
	 *            the user complaint object that needs to be merged into the
