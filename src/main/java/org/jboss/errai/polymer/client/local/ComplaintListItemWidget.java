...
public class ComplaintListItemWidget extends Composite implements
		HasModel<UserComplaint> {

	/**
	 * Errai's data binding module will automatically bind the provided instance
	 * of the model (see {@link #setModel(UserComplaint)}) to all fields
	 * annotated with {@link Bound}. If not specified otherwise, the bindings
	 * occur based on matching field names (e.g. userComplaint.id will
	 * automatically be kept in sync with the data-field "id")
	 */
	@Inject
	@AutoBound
